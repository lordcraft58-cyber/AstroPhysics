...
- [`docs/audit/12-FASE9.6-QT-PIXINSIGHT-GUI.md`](docs/audit/12-FASE9.6-QT-PIXINSIGHT-GUI.md) — Fase 9.6: taller de procesamiento `qt_app/` (PySide6) — MDI, explorador de procesos arrastrable, STF no destructivo, consola integrada, procesos reales cableados (rayos cósmicos, overscan, fotometría de apertura, ajuste de continuo).
